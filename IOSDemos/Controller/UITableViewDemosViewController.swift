...
class UITableViewDemosViewController: UIViewController, UITableViewDemosDelegate {
    ...
    override func viewDidLoad() {
        ...
        let selfview: UITableViewDemos = UITableViewDemos(frame: CGRect(x: kselfviewX, y: kselfviewY, width: kselfviewW, height: kselfviewH))
    ...
    func btnSimpleTablePressed(btnObj: UIButton){
        let simpleTableVC: SimpleTableViewController = SimpleTableViewController()
        
        self.present(simpleTableVC, animated: true) {
            
        }
    }
    
    func btnCommonTablePressed(btnObj: UIButton){
        let commonTableVC: CommonTableViewController = CommonTableViewController()
        
        self.present(commonTableVC, animated: true) {
