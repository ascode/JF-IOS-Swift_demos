...
class TabDemosViewController: UITabBarController, TabAndDrawerDemosViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let selfview: TabAndDrawerDemosView = TabAndDrawerDemosView(frame: CGRect(x: kselfviewX, y: kselfviewY, width: kselfviewW, height: kselfviewH))
