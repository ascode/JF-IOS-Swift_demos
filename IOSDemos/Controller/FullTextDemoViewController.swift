//
//  FullTextDemoViewController.swift
//  IOSDemos
//
...
class FullTextDemoViewController: UIViewController, FullTextDemoViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let selfview: FullTextDemoView = FullTextDemoView(frame: CGRect(x: kselfviewX, y: kselfviewY, width: kselfviewW, height: kselfviewH))
