...
class ModalAViewController: UIViewController, ModalADelegate {
    ...
    override func viewDidLoad() {
        ...
        let selfview: ModalA = ModalA(frame: CGRect(x: kselfviewX, y: kselfviewY, width: kselfviewW, height: kselfviewH))
