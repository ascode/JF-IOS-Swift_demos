...
class SpeechSynthesizerDemoViewController: UIViewController, SpeechSynthesizerDemoViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let selfview: SpeechSynthesizerDemoView = SpeechSynthesizerDemoView(frame: CGRect(x: kselfviewX, y: kselfviewY, width: kselfviewW, height: kselfviewH))
